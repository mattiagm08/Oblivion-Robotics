...
MAX_SPEED = 255   # VELOCITÀ MASSIMA UTILIZZATA NEI TRATTI RETTILINEI
MIN_SPEED = 140   # VELOCITÀ MINIMA PER CURVE STRETTE O CORREZIONI AGGRESSIVE
GAP_SPEED = 130   # VELOCITÀ COSTANTE DURANTE ATTRAVERSAMENTO GAP
BACK_SPEED = 200  # VELOCITÀ IN RETROMARCIA DURANTE FASE DI RECUPERO DOPO PERDITA LINEA PROLUNGATA
...
GAP_TIMEOUT       = 2.5  # TIMEOUT GAP IN SECONDI
