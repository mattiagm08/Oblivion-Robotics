...
MAX_SPEED = 240   # VELOCITÀ MASSIMA UTILIZZATA NEI TRATTI RETTILINEI
MIN_SPEED = 150   # VELOCITÀ MINIMA PER CURVE STRETTE O CORREZIONI AGGRESSIVE
GAP_SPEED = 125   # VELOCITÀ COSTANTE DURANTE ATTRAVERSAMENTO GAP
